...
#define BLYNK_TEMPLATE_ID "TMPL6PprXDmu2"
#define BLYNK_TEMPLATE_NAME "DHT by Minahal"
#define BLYNK_AUTH_TOKEN "XB4v73uJ4gVGRZh68IwUjAhYSCDqq0O-" // <-- from Blynk device_hLmtVUUWlhtBanXKpviBJt0D_zIBJsA
